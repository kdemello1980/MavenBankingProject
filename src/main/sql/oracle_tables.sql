...
CREATE TABLE kmdm_accounts (
    account_id NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 100000 INCREMENT BY 28),
    balance NUMBER(38,2) NOT NULL DEFAULT 0.00,
    status NUMBER,
    type_id NUMBER,
...
CREATE TABLE kmdm_account_status(
    ...
    status VARCHAR2(64) NOT NULL UNIQUE,
